...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../public/css/blogsboard_desktop.css">
    <style type="text/css">
    ...
    <?php if($agent->isDesktop()): ?>
        <link rel="stylesheet" href="<?php echo e(asset('css/blogsboard_desktop.css')); ?>">
    <?php elseif($agent->isTablet()): ?>
        <link rel="stylesheet" href="<?php echo e(asset('css/blogsboard_tablet.css')); ?>">
    <?php elseif($agent->isMobile()): ?>
        <link rel="stylesheet" href="<?php echo e(asset('css/blogsboard_mobile.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('css/blogsboard_desktop.css')); ?>">
    <?php endif; ?>
        ...
        <div id="newsfeed">
            <header>
                <section class="features" style="padding-top: 0 !important;">
                    ...
                    <br/>
                        <br/>
                        <h2 id="covertitle" style="text-align: center; color: white; letter-spacing: 2px;">Παναγιώτης Κουτρουζά Blogs</h2>
                    <br/>
                                ...
                                <div href="<?php echo e(url("blog/".$blog->id)); ?>" class="details_exp" style="text-align: left; cursor: pointer;" onClick="location.href = '<?php echo e($blog); ?>'">
                                    ...
                                    <table class="table-responsive" style="border: none;">
                                        <th style="width: 50%;">
                                            ...
                                            <img class="blogImg" src="<?php echo e(asset('uploads/'.$blog->imgUpload)); ?>" alt="" style="padding-right: 50%; max-height: 300px;"/>
                                                <?php else: ?>
